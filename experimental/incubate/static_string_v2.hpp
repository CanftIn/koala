...
#define SSTOU(x) static_string_to_uint((x))
  ...
  namespace static_string_detail {
    ...
    template<typename Char, size_t Size>
    constexpr basic_static_string<Char, Size>
    make(const basic_static_string<Char, Size>& str) {
      return str;
    }

    template<typename Char, size_t Size>
    constexpr basic_static_string<Char, Size>
    make(const Char (& str)[Size]) {
      return make(str, make_index_sequence<Size - 1>{});
    }

    template<typename Char, Char ... Chars>
    constexpr basic_static_string<Char, sizeof ... (Chars) + 1>
    make(char_sequence<Char, Chars ...>) {
      return {Chars ..., static_cast<Char>('\0')};
    }

    template<typename Char, size_t Size, size_t ... Indexes>
    constexpr basic_static_string<Char, sizeof ... (Indexes) + 1>
    make(const Char (& str)[Size], index_sequence<Indexes ...>) {
    ...
    constexpr int compare(const basic_static_string<Char, Size1>& str1,
      ...
      return compare(str1, static_string_detail::make(str2));
    }

    template<typename Char, size_t Size1, size_t Size2>
    constexpr int compare(const Char (& str1)[Size1],
                          const basic_static_string<Char, Size2>& str2) {
      return compare(static_string_detail::make(str1), str2);
    }

    template<typename Char, size_t Size1, size_t Size2>
    constexpr int static_string_compare(const Char (& str1)[Size1],
                                        const Char (& str2)[Size2]) {
      return compare(static_string_detail::make(str1),
                     static_string_detail::make(str2));
    }

    template<typename Char, size_t Size1, size_t ... Indexes1, size_t Size2, size_t ... Indexes2>
    constexpr basic_static_string<Char, Size1 + Size2 - 1>
    concat2(const basic_static_string<Char, Size1>& str1, index_sequence<Indexes1 ...>,
    ...
    template<typename Char, size_t Size1, size_t Size2>
    constexpr basic_static_string<Char, Size1 + Size2 - 1>
    concat2(const basic_static_string<Char, Size1>& str1,
            const basic_static_string<Char, Size2>& str2) {
    ...
    template<typename Char>
    constexpr basic_static_string<Char, 1>
    concat() {
    ...
    constexpr long long to_int(const basic_static_string<Char, Size>& str) {
      return Size < 2 ? 0LL :
          str.data[0] == static_cast<Char>('-') ? static_string_detail::to_int(str, Size - 2, 1) :
          static_string_detail::to_int(str, Size - 2, 0);
    }
  ...
  struct basic_static_string {
    ...
    template<typename ... Args> static constexpr auto make(Args&& ... args) {
      return static_string_detail::concat<Char>(std::forward<Args>(args) ...);
    }
    constexpr auto reverse() const {
      return static_string_detail::make(*this, static_string_detail::make_reverse_index_sequence<Size - 1>{});
    }
    template<size_t Begin, size_t End> constexpr auto substring() const {
      ...
      return static_string_detail::make(*this, static_string_detail::make_index_subsequence<Begin, End>{});
    }
    ...
    template<size_t SubSize> constexpr size_t find(const basic_static_string<Char, SubSize>& substr, size_t from = 0, size_t nth = 0) const {
      return Size < SubSize || from > Size - SubSize ? npos :
          static_string_detail::compare(*this, from, substr, 0, 1, SubSize - 1) != 0 ? find(substr, from + 1, nth) :
    ...
    template<size_t SubSize> constexpr size_t find(const Char (& substr)[SubSize], size_t from = 0, size_t nth = 0) const {
      return find(static_string_detail::make(substr), from, nth);
    }
    ...
    template<size_t SubSize> constexpr size_t rfind(const basic_static_string<Char, SubSize>& substr, size_t from = Size - SubSize, size_t nth = 0) const {
      return Size < SubSize || from > Size - SubSize ? npos :
          static_string_detail::compare(*this, from, substr, 0, 1, SubSize - 1) != 0 ? rfind(substr, from - 1, nth) :
    ...
    template<size_t SubSize> constexpr size_t rfind(const Char (& substr)[SubSize], size_t from = Size - SubSize, size_t nth = 0) const {
      return rfind(static_string_detail::make(substr), from, nth);
    }
    ...
    template<size_t SubSize> constexpr bool starts_with(const basic_static_string<Char, SubSize>& prefix) const {
      return SubSize > Size ? false : static_string_detail::compare(*this, 0, prefix, 0, 1, SubSize - 1) == 0;
    }
    template<size_t SubSize> constexpr bool starts_with(const Char (& prefix)[SubSize]) const {
      return starts_with(static_string_detail::make(prefix));
    }
    template<size_t SubSize> constexpr bool ends_with(const basic_static_string<Char, SubSize>& suffix) const {
      return SubSize > Size ? false : static_string_detail::compare(*this, Size - SubSize, suffix, 0, 1, SubSize - 1) == 0;
    }
    template<size_t SubSize> constexpr bool ends_with(const Char (& suffix)[SubSize]) const {
      return ends_with(static_string_detail::make(suffix));
    }
    constexpr size_t count(Char ch) const {
      return static_string_detail::count(*this, ch, 0);
    }
    ...
    constexpr unsigned long long hash() const {
        return static_string_detail::hash(*this, 0);
    }
    constexpr Char operator[](size_t index) const {
        return data[index];
    }
    constexpr long long to_int() const {
        return static_string_detail::to_int(*this);
    }
    constexpr unsigned long long to_uint() const {
        return static_string_detail::to_uint(*this, 0);
    }
    std::string str() const {
        return static_string_detail::to_string(*this);
    }
    constexpr auto lower() const {
        return static_string_detail::lower(*this, static_string_detail::make_index_sequence<Size>{});
    }
    constexpr auto upper() const {
        return static_string_detail::upper(*this, static_string_detail::make_index_sequence<Size>{});
    }
  ...
  constexpr bool operator==(const basic_static_string<Char, Size1>& str1, const basic_static_string<Char, Size2>& str2) {
    return static_string_detail::compare(str1, str2) == 0;
  }
